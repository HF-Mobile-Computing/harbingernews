...
<head>
	...
	<title>Admin Console | <?php echo $club_item['name']; ?></title>
...
<body>
	...
	<div id="content">
		<div class="container">
			<h1><?php echo $club_item['name']; ?></h1>
			
			<?php echo form_open('admin/clubs/' . $club_item['slug'] ); ?>
				<fieldset>
					<textarea name="content" class="ckeditor"><?php echo $club_item['content']; ?></textarea><br />
