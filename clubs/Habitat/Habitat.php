...
<body>
	<div id = "content" style ="">
		...
		<div id="info" class="container">
			...
			<div class="row">
				<div class = "about">
					<h4 class = "offset1">About Habitat for Humanity</h4>
					<p>Advisor: Ms. Gold</p> 
					<p>Room: 212</p>
					<p>The Habitat for Humanity club at Harborfields High School provides students the opportunity to work together with needy families on long Island. The students have many fund raisers throughout the year. This money allows them to be involved in a hands-on building experience and to help hard working families fulfill their dreams of owning their own home. The club meets bi weekly. All students are welcome to join. The privilege to build is based on years of participation and age of each student.</p>
					<br/>
					<p>This club meets on the 1st and 3rd Wednesdays of the month at 2:30pm</p>
