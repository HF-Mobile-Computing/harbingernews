...
<body>
	<div id = "content" style ="">
		...
		<div id="info" class="container">
			...
			<div class="row">
				<div class = "about">
					<h4 class = "offset1">About Mock Trial</h4>
					<p>Advisor: Ms. Schoer</p> 
					<p>Room: <em>Coming Soon</em></p>
					<p>Would-be lawyers might be interested in some practical training. A practicing attorney works
with our students and prepares them for courtroom competitions. There are no requirements to
join and in the past, some of the best participants have been 9th graders.
</p>
					<br/>
					<p>Dates TBD, 5-7:30pm.</p>
					<p>Competition Begins in January.</p>
