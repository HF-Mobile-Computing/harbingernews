...
<body>
	<div id = "content" style ="">
		...
		<div id="info" class="container">
			...
			<div class="row">
				<div class = "about">
					<h4 class = "offset1">About Model UN</h4>
					<p>Advisor: Ms. Greening</p> 
					<p>Room: 306</p>
					<p>The Model United Nations is an excellent way for students to become familiar with the issues
and concerns of our world. Through role-playing the representatives of the U.N. Member States,
students learn about other countries and cultures, while developing a global perspective on issues
confronting the world community. The club focuses on preparing to participate in the Yale
University Model U.N. There are no requirements to join Model U.N. The Model U.N. club
generally meets once per week
</p>
					<br/>
					<p>This club meets on the 1st and 3rd Wednesdays of each month, at 2:30</p>
