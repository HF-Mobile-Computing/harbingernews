...
<body>
	<div id = "content" style ="">
		...
		<div id="info" class="container">
			...
			<div class="row">
				<div class = "about">
					<h4 class = "offset1">About the Caribbean Club</h4>
					<p>Advisor: Ms. Koenig</p> 
					<p>Room: Guidance Resource Center</p>
					<p>The Caribbean Club is open to all students to come together and learn from each other about different Caribbean cultures, languages, food and music. Our club also has a social service component where we raise awareness and participate in community service activities. We also have a holiday and year end party featuring a Caribbean feast!</p>
					<br/>
					<p>This club meets on the 2nd and 4th Thursdays of each month, from 2:30-3:30pm</p>
