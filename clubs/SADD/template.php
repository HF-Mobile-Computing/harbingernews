...
<body>
	<div id = "content" style ="">
		...
		<div id="info" class="container">
			...
			<div class="row">
				<div class = "about">
					<h4 class = "offset1">About SADD</h4>
					<p>Advisor: Ms. Ambrosio</p> 
					<p>Room: T20</p>
					<p>The S.A.D.D. club is designed to promote the awareness of destructive decisions and the dangers
of drinking and driving. Our club generally meets once a month to plan events and activities
throughout the school year. The club is offered to all students in grades 9 – 12
</p>
					<br/>
					<p>This club meets monthly on Wednesdays at 2:30. See advisor for details.</p>
