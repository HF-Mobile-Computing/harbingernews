...
<body>
	<div id = "content" style ="">
		...
		<div id="info" class="container">
			...
			<div class="row">
				<div class = "about">
					<h4 class = "offset1">About Matheletes</h4>
					<p>Advisor: Mr. Bennett</p> 
					<p>Room: 108</p>
					<p>The math department encourages strong math students to test their abilities in competition against other schools in Suffolk County. There are no requirements to join other than a strong interest in math.</p>
					<p>In its latest meet, the Mathletes team scored 24 out of a possible 30 points, maintaining its hold on third place in the county.  Super-soph Alicia Chang scored a PERFECT  6 out of 6, an astounding feat, especially for a tenth-grader!!!  Congratulations!!</p>
					<br/>
					<p>This club meets Mondays from 2:30-3:15</p>
