...
class SportsControllerTest < ActionController::TestCase
  ...
  test "should create sport" do
    assert_difference('Sport.count') do
      post :create, sport: { content: @sport.content, photo_path: @sport.photo_path, season: @sport.season, slug: @sport.slug, title: @sport.title }
    end
  ...
  test "should update sport" do
    put :update, id: @sport, sport: { content: @sport.content, photo_path: @sport.photo_path, season: @sport.season, slug: @sport.slug, title: @sport.title }
    assert_redirected_to sport_path(assigns(:sport))
  end
